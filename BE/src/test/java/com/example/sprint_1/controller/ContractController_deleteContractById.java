...
class ContractController_deleteContractById {
    @Autowired
    private MockMvc mockMvc;

    // xóa contract với id = "null"
    @Test
    void deleteCOntractById_25() throws Exception {
    ...
    //xóa contract với id = ""
    @Test
    void deleteCustomerById_26() throws Exception {
        this.mockMvc.perform(
    ...
    @Test
    void deleteContractById_27() throws Exception {
        this.mockMvc.perform(
    ...
    @Test
    void deleteContractById_28() throws Exception {
        this.mockMvc.perform(
