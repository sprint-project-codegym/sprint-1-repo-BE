...
public interface PersonalInfoRepository extends JpaRepository<Employee, String> {
    ...
    //    @Query(value = "select e.employee_name, e.employee_gender, " +
//            "e.employee_birthday, e.employee_gmail, e.employee_phone, e.employee_address from employee as e " +
//            "where employee_id = :employeeId", nativeQuery = true)
    ...
    // Lỗi: Khi select * thì code sẽ chạy, còn khi select từng trường thì sẽ bị lỗi employee_id not found
